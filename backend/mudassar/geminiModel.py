...
with open(
    ...
    for i, review in enumerate(data):
        topics = gemini(review["review_text"], array)
        review["review_topics"] = topics.split(", ")

        print(i)

with open("F:/react projects/reviews-classifier/backend/mudassar/pocoC55.json", "w") as f:
